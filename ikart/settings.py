...
# Background tasks. Delivery still runs inline until the worker rollout lands.
...
CELERY_TASK_MAX_RETRIES = env.int("CELERY_TASK_MAX_RETRIES", default=5)
CELERY_TASK_DEFAULT_QUEUE = "ikart"
CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP = True
CELERY_BROKER_TRANSPORT_OPTIONS = {"visibility_timeout": 3600}
CELERY_TIMEZONE = TIME_ZONE
PAYMENT_SWEEP_CRON_MINUTES = env.int("PAYMENT_SWEEP_CRON_MINUTES", default=15)
